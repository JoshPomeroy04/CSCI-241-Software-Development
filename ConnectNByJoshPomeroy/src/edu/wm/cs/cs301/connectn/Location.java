/**
 * Creates the Location object which is used to store information about 
 * each tile on the board. Stores the current symbol in the tile and stores
 * how many tiles with the same symbol it's connected to
 * 
 * @author Josh Pomeroy
 */
