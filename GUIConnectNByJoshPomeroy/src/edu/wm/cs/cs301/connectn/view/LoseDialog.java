/**
 * Class that creates the window that pops up when the player loses
 * 
 * @author Josh Pomeroy
 */
...
public class LoseDialog extends JDialog{
	...
	public LoseDialog(ConnectNFrame view, ConnectNModel model) {
		super(view.getFrame(), "Unlucky", true);
	...
	private JPanel createMainPanel() {
		...
		JLabel mainText = new JLabel("You Lost!");
