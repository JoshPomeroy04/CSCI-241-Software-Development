...
public class WordleModel {
	...
	public WordleModel() {
		...
		this.currentRow = 0;
		this.columnCount = 5;         // Word length
		this.maximumRows = 6;         // Guesses
	...
	public boolean setCurrentRow() {	
		// Loops through each guessed character
		...
		// Returns true if the player has more guesses, returns false if they used their last guess
		return currentRow < maximumRows;
	}
	
	public void setHintLocation(int location, char letter) {
		guess[location] = letter;
		wordleGrid[currentRow-1][location] = new WordleResponse(guess[location],
