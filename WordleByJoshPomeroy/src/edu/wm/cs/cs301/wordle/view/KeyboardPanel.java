...
public class KeyboardPanel {
	...
	private final HintButton hint;

	public KeyboardPanel(WordleFrame view, WordleModel model, HintButton hint) {
		this.model = model;
		this.hint = hint;
		this.buttonIndex = 0;
		...
		this.action = new KeyboardButtonAction(view, model, hint);
	...
	private JPanel createMainPanel() {
		...
		panel.add(this.hint.getHintButton());
	...
	public void regenPanel() {
		this.panel.remove(4);
		this.panel.add(createTotalPanel());
	}
